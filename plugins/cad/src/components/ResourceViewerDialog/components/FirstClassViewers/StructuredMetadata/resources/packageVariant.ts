...
export const getPackageVariantStructuredMetadata = (
  ...
  // setSpecdata(newMetadata, packageVariant.spec.upstream, "upstream");
  // setSpecdata(newMetadata, packageVariant.spec.downstream, "downstream");
  // setSpecdata(newMetadata, packageVariant.spec.labels, "labels");
  // setSpecdata(newMetadata, packageVariant.spec.packageContext, "packageContext");
  // setSpecdata(newMetadata, packageVariant.spec.injectors, "injectors");
  // setSpecdata(newMetadata, packageVariant.spec.pipeline, "pipeline");
